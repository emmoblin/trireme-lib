...
const (
	aporetoPrefix    = "APORETO-"
	uidchain         = aporetoPrefix + "UIDCHAIN"
	chainPrefix      = aporetoPrefix + "TRIREME-"
	appChainPrefix   = aporetoPrefix + chainPrefix + "App-"
	netChainPrefix   = aporetoPrefix + chainPrefix + "Net-"
	targetNetworkSet = aporetoPrefix + "TargetNetSet"
	// PuPortSet The prefix for portset names
	PuPortSet                = aporetoPrefix + "PUPort-"
	proxyPortSetPrefix       = aporetoPrefix + "Proxy-"
	ipTableSectionOutput     = aporetoPrefix + "OUTPUT"
	ipTableSectionInput      = aporetoPrefix + "INPUT"
	ipTableSectionPreRouting = aporetoPrefix + "PREROUTING"
	natProxyOutputChain      = aporetoPrefix + "RedirProxy-App"
	natProxyInputChain       = aporetoPrefix + "RedirProxy-Net"
	proxyOutputChain         = aporetoPrefix + "Proxy-App"
	proxyInputChain          = aporetoPrefix + "Proxy-Net"
	proxyMark                = "0x40"
